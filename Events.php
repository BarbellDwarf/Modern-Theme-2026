...
class Events
{
    ...
    public static function onBeforeAction($event)
    {
        ...
        $overrides = [
            ...
            // User profile views — phone/email as clickable links
            Yii::getAlias('@humhub/modules/user') . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'profile'
                => $modulePath . DIRECTORY_SEPARATOR . 'views' . DIRECTORY_SEPARATOR . 'user' . DIRECTORY_SEPARATOR . 'profile',
